...
<body>
    ...
    <nav>
        ...
        <ul>
            ...
            <li><a href="register.php"><u>REGISTER CUSTOMER</u></a></li> 
            <li><a href="registeradm.php"><u>REGISTER ADMINISTRATOR</u></a></li> 
				...
				<div class="main-login main-center">
					<form class="form-horizontal" method="post" action="#">
						...
						<div class="form-group">
							<label for="name" class="cols-sm-2 control-label">Name Administrator</label>
