...
<nav>
        ...
        <ul>
            ...
            <li><a href="services1.php"><u>SERVICES  PRODUCTS</u></a></li>         
...
<section id="services">
  ...
  <section class="py-5 mt-4 bg-warning text-light">
    <div class="container">
        <div class="row">
            <h2>Choose the service you are looking for!</h2>
        </div>
    </div>
</section>
    ...
    <div class="container">
       <div class="row">
           <div class="col-xs-12 col-sm-6 col-md-3">
               <a href="registervehicle.php" class="text-body">
    		    <div class="card bg-warning mb-3">
    		        <div class="card-body">
    		           <i class="fa fa-tachometer fa-4x "></i></br>
                        <small class="text-secondary">Book Now</small>
...
<section class="py-5 mt-4 bg-warning text-light">
  <div class="container">
      <div class="row">
          <h2>Choose the products you are looking for!</h2>
      </div>
  </div>
</section>
<!--AQUI PARA EU OS PRODUCTOS  -->
<section class="services py-5 bg-light text-center">
  <div class="container">
     <div class="row">
         <div class="col-xs-12 col-sm-6 col-md-3">
             <a href="#" onclick="myFunction()" class="text-body">
              <div class="card bg-warning mb-3">
                  <div class="card-body">
                     <i class="fa fa-tachometer fa-4x "></i></br>
                      <small class="text-secondary">To Buy</small>
                      <h5>Air Filter</h5>
                  </div>
              </div>
             </a>
         ...
         <div class="col-xs-12 col-sm-6 col-md-3">
          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
             <ahref="#" onclick="myFunction()" class="text-body">
              <div class="card bg-warning mb-3">
                  <div class="card-body">
                     <i class="fa fa-tachometer fa-4x "></i></br>
                      <small class="text-secondary">To Buy</small>
